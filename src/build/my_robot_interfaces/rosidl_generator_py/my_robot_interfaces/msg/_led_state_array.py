...
class LedStateArray(metaclass=Metaclass_LedStateArray):
    ...
    def __init__(self, **kwargs):
        ...
        self.led_state = array.array('q', kwargs.get('led_state', []))
    ...
    def led_state(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'q', \
                "The 'led_state' array.array() must have the type code of 'q'"
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'led_state' field must be a set or sequence and each value of type 'int' and each integer in [-9223372036854775808, 9223372036854775807]"
        self._led_state = array.array('q', value)
