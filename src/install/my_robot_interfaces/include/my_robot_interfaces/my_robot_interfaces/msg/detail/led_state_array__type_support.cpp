...
size_t size_function__LedStateArray__led_state(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<int64_t> *>(untyped_member);
  return member->size();
}

const void * get_const_function__LedStateArray__led_state(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__LedStateArray__led_state(void * untyped_member, size_t index)
{
  auto & member =
...
void fetch_function__LedStateArray__led_state(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const int64_t *>(
    get_const_function__LedStateArray__led_state(untyped_member, index));
  auto & value = *reinterpret_cast<int64_t *>(untyped_value);
  value = item;
}

void assign_function__LedStateArray__led_state(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<int64_t *>(
    get_function__LedStateArray__led_state(untyped_member, index));
  const auto & value = *reinterpret_cast<const int64_t *>(untyped_value);
  item = value;
}

void resize_function__LedStateArray__led_state(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<int64_t> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LedStateArray_message_member_array[1] = {
  {
    ...
    offsetof(my_robot_interfaces::msg::LedStateArray, led_state),  // bytes offset in struct
    nullptr,  // default value
    size_function__LedStateArray__led_state,  // size() function pointer
    get_const_function__LedStateArray__led_state,  // get_const(index) function pointer
    get_function__LedStateArray__led_state,  // get(index) function pointer
    fetch_function__LedStateArray__led_state,  // fetch(index, &value) function pointer
    assign_function__LedStateArray__led_state,  // assign(index, value) function pointer
    resize_function__LedStateArray__led_state  // resize(index) function pointer
  }
};
