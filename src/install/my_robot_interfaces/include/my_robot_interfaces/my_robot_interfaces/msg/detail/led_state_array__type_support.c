...
size_t my_robot_interfaces__msg__LedStateArray__rosidl_typesupport_introspection_c__size_function__LedStateArray__led_state(
...
const void * my_robot_interfaces__msg__LedStateArray__rosidl_typesupport_introspection_c__get_const_function__LedStateArray__led_state(
...
void * my_robot_interfaces__msg__LedStateArray__rosidl_typesupport_introspection_c__get_function__LedStateArray__led_state(
...
void my_robot_interfaces__msg__LedStateArray__rosidl_typesupport_introspection_c__fetch_function__LedStateArray__led_state(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const int64_t * item =
    ((const int64_t *)
    my_robot_interfaces__msg__LedStateArray__rosidl_typesupport_introspection_c__get_const_function__LedStateArray__led_state(untyped_member, index));
  int64_t * value =
    (int64_t *)(untyped_value);
  *value = *item;
}

void my_robot_interfaces__msg__LedStateArray__rosidl_typesupport_introspection_c__assign_function__LedStateArray__led_state(
  void * untyped_member, size_t index, const void * untyped_value)
{
  int64_t * item =
    ((int64_t *)
    my_robot_interfaces__msg__LedStateArray__rosidl_typesupport_introspection_c__get_function__LedStateArray__led_state(untyped_member, index));
  const int64_t * value =
    (const int64_t *)(untyped_value);
  *item = *value;
}

bool my_robot_interfaces__msg__LedStateArray__rosidl_typesupport_introspection_c__resize_function__LedStateArray__led_state(
...
static rosidl_typesupport_introspection_c__MessageMember my_robot_interfaces__msg__LedStateArray__rosidl_typesupport_introspection_c__LedStateArray_message_member_array[1] = {
  {
    ...
    offsetof(my_robot_interfaces__msg__LedStateArray, led_state),  // bytes offset in struct
    NULL,  // default value
    my_robot_interfaces__msg__LedStateArray__rosidl_typesupport_introspection_c__size_function__LedStateArray__led_state,  // size() function pointer
    my_robot_interfaces__msg__LedStateArray__rosidl_typesupport_introspection_c__get_const_function__LedStateArray__led_state,  // get_const(index) function pointer
    my_robot_interfaces__msg__LedStateArray__rosidl_typesupport_introspection_c__get_function__LedStateArray__led_state,  // get(index) function pointer
    my_robot_interfaces__msg__LedStateArray__rosidl_typesupport_introspection_c__fetch_function__LedStateArray__led_state,  // fetch(index, &value) function pointer
    my_robot_interfaces__msg__LedStateArray__rosidl_typesupport_introspection_c__assign_function__LedStateArray__led_state,  // assign(index, value) function pointer
    my_robot_interfaces__msg__LedStateArray__rosidl_typesupport_introspection_c__resize_function__LedStateArray__led_state  // resize(index) function pointer
  }
};
