...
bool my_robot_interfaces__msg__turtle_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // turtles
    ...
    if (!my_robot_interfaces__msg__turtle__convert_from_py(field, &ros_message->turtles)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * my_robot_interfaces__msg__turtle_array__convert_to_py(void * raw_ros_message)
{
  ...
  {  // turtles
    PyObject * field = NULL;
    field = my_robot_interfaces__msg__turtle__convert_to_py(&ros_message->turtles);
    if (!field) {
      return NULL;
    }
    {
